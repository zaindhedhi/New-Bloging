...
const Home = () => {
  ...
  return (
    ...
    return <div key={item.uid} className='flex w-[50%] px-7 py-5 flex-col bg-[#ffffff] justify-center items-start gap-4 rounded-lg shadow-lg  min-h-[40vh] min-w-[300px] m-10 border border-black'>
